...
class MultiAssetsPickerFirst extends StatefulWidget {
  ...
  @override
  _MultiAssetsPickerFirstState createState() => _MultiAssetsPickerFirstState();
}

class _MultiAssetsPickerFirstState extends State<MultiAssetsPickerFirst> {
      ...
      if (result != null && result != assets) {
        ...
        if (mounted) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => AddGigDetailsSecond(selectedAssets: assets),
            ),
          );
        }
      }
